        ...
        <div class="container-fluid">
            <div class="row mb-lg-2">
                <div class="col-12 d-inline-flex align-items-center justify-content-between">
                    <h2 class="h4 section-title mb-2"><?php esc_html_e( 'Add New Rule', 'wp-dxp' ); ?></h2>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-12">
                    <p class="section-description"><?php esc_html_e( 'Create a new rule using the options below. Once the rule has been added, it will become active or inactive, depending on the conditions chosen.', 'wp-dxp' ); ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row mb-lg-2">
                <div class="col-12 col-lg-10">
                    ...
                    <form action="<?php echo WP_DXP_ADMIN_RULES_CREATE_URL; ?>" method="post" accept-charset="UTF-8" id="wp-dxp-rule-form">
                        <?php
